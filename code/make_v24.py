# -*- coding: utf-8 -*-
"""Generate v24 from v23: normal-vs-tumour and immunotherapy analyses."""
import docx
    ...
    ("3.15 FDPS DNA methylation is inversely associated",
     [
         ("3.16 Cholesterol genes are remodelled in tumour versus normal "
          "breast tissue\n",
          "In a paired normal-tumour cohort (GSE15852, 43 pairs), "
          "cholesterol biosynthetic enzymes were significantly "
          "up-regulated in tumours: DHCR24 (log2 fold change 0.59, "
          "paired Wilcoxon P = 7e-4), DHCR7 (0.82, P = 2.8e-3), HSD17B7 "
          "(0.36, P = 1.2e-3), HMGCS2 (0.83, P = 0.13) and FDPS (0.93, "
          "P = 1e-4), whereas the cholesterol-uptake receptor VLDLR "
          "(-0.52, P < 1e-4), PRKAA1 (-0.51, P = 0.026), LIMA1 (-0.22, "
          "P = 2.4e-3) and NSDHL (-0.19, P = 0.022) were down-regulated, "
          "indicating coordinated pathway remodelling during "
          "tumourigenesis rather than uniform up-regulation "
          "(Supplementary Figure S9; Supplementary Table S19)."),
         ("3.17 Exploratory immunotherapy-response associations\n",
          "In the pre-treatment samples of an anti-PD-1 melanoma cohort "
          "(GSE91061, n = 51; 10 responders CR/PR, 23 non-responders "
          "PD), immune-cytotoxic features trended higher in responders "
          "(CD8A P = 0.096; GZMA P = 0.18; PRF1 P = 0.13; cytolytic "
          "score P = 0.16) and most cholesterol genes showed no "
          "directionally consistent association with response "
          "(Supplementary Figure S10; Supplementary Table S20). These "
          "cross-cancer exploratory analyses were not powered to reach "
          "significance and are reported for transparency."),
     ]),
]
