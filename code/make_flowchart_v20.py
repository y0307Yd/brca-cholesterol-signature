...
fig.savefig(r"outputs\chol_metab_signature\figures\supp_fig2_design_flowchart_v20.png",
            dpi=300, bbox_inches="tight")
print("saved supp_fig2 v20")
