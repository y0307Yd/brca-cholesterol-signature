...
rows = [
    ...
    },
    {
        ...
        "Cohorts": "TCGA-BRCA; METABRIC, GSE21653, GSE7390, GSE20711 (validation)",
        "Selection": "WGCNA + cholesterol gene set intersection; LASSO + SVM-RFE",
        "Validation": "4 external expression cohorts; ER-classifier AUC 0.83-0.92; subtype external mapping",
