# -*- coding: utf-8 -*-
"""QA checks for v25 (TCGA-vs-GTEx normal-tumour confirmation)."""
import re
...
added = {
    ...
    "Xena confirm": "n = 1,092" in body and "GTEx normal breast tissue (n = 179)" in body,
    "Fig S11": "Supplementary Figure S11" in body,
    "Table S21": "Supplementary Table S21" in body,
    "S1-S21/S1-S11": "S1-S21" in "\n".join(paras)
    and "S1-S11" in "\n".join(paras),
    "3.17 still present": "3.17 Exploratory immunotherapy-response" in body,
}
